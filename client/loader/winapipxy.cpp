...
// Init JK2MF on first call over here
// bypasses jk2's detection like that
extern "C" MMRESULT __stdcall __E__144__(UINT t)
{
	Init();

	typedef MMRESULT (__stdcall *pFunc)(UINT);
	pFunc p = (pFunc)pointers[144];
	return p(t);
}
