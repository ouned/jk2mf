...
#else
#define	MAX_OSPATH 4095 // ouned: don't ask me where this comes from but it's set to this in the original jk2ded linux
#endif
...
typedef enum {
	BLOCKED_NONE104,
	BLOCKED_BOUNCE_MOVE104,
	BLOCKED_PARRY_BROKEN104,
	BLOCKED_ATK_BOUNCE104,
	BLOCKED_UPPER_RIGHT104,
	BLOCKED_UPPER_LEFT104,
	BLOCKED_LOWER_RIGHT104,
	BLOCKED_LOWER_LEFT104,
	BLOCKED_TOP104,
	BLOCKED_UPPER_RIGHT_PROJ104,
	BLOCKED_UPPER_LEFT_PROJ104,
	BLOCKED_LOWER_RIGHT_PROJ104,
	BLOCKED_LOWER_LEFT_PROJ104,
	BLOCKED_TOP_PROJ104
} saberBlockedType104_t;

typedef enum {
	BLOCKED_NONE102,
	BLOCKED_PARRY_BROKEN102,
	BLOCKED_ATK_BOUNCE102,
	BLOCKED_UPPER_RIGHT102,
	BLOCKED_UPPER_LEFT102,
	BLOCKED_LOWER_RIGHT102,
	BLOCKED_LOWER_LEFT102,
	BLOCKED_TOP102,
	BLOCKED_UPPER_RIGHT_PROJ102,
	BLOCKED_UPPER_LEFT_PROJ102,
	BLOCKED_LOWER_RIGHT_PROJ102,
	BLOCKED_LOWER_LEFT_PROJ102,
	BLOCKED_TOP_PROJ102
} saberBlockedType102_t;
...
typedef struct playerState102_s {
	int			commandTime;	// cmd->serverTime of last executed command
	int			pm_type;
	int			bobCycle;		// for view bobbing and footstep generation
	int			pm_flags;		// ducked, jump_held, etc
