...
// ouned: i have no idea what im doing
extern "C" void qftol(void);
__asm__(
	".text\n\t"
	".p2align 4,,15\n\t"
#if defined __ELF__
	".type " CMANG(qftol) ", @function\n"
#endif
    CMANG(qftol) ":\n\t"
  "fnstcw	fpucw\n"
  "fldcw	cw0F7F\n"
...
extern "C" void __attribute__((cdecl, used, force_align_arg_pointer)) CallAsmCall(int const syscallNum,
