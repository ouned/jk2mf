...
//v1.03
#define	PROTOCOL_VERSION102	15
#define	PROTOCOL_VERSION104	16
...
const char *FS_ReferencedPakNames_Ori(void);
const char *FS_ReferencedPakChecksums( void );
const char *FS_ReferencedPakChecksums_Ori(void);
